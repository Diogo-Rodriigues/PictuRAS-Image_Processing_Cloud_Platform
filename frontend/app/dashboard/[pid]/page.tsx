...
import { ShareProjectDialog } from "@/components/project-page/invite-people-dialog";
...
import { ProjectLinksManager } from "@/components/project-page/project-links-manager";
...
export default function Project({
  ...
  useLayoutEffect(() => {
    if (
      !["edit", "results", "links"].includes(mode) ||
    ...
    >
      <div className="flex flex-col h-screen relative">
        ...
        <div className="h-full overflow-x-hidden flex">
          {mode === "links" ? (
            <ProjectLinksManager pid={project.data._id} />
          ) : (
            <>
